...
namespace sluggish.imageprocessing
{
	...
	public class region
	{
                    ...
                    for (int x = 0; x < image_width; x++)
                    {
                        ...
                        for (int y = 0; y < image_height; y++)
                        {
                            ...
                            if (hyp > 0)
                            {
                                ...
                                int x_original = (int)(centre_x + (hyp * (float)Math.Cos(angle)));
                                int y_original = (int)(centre_y - (hyp * (float)Math.Sin(angle)));
                                 ...
                                 float suppression_radius_factor)
        {
            ...
            horizontal_maxima = fitGridMaxima(grid_spacing_horizontal, pixels_per_index, min_grid_threshold, true, grid_padding, true, suppression_radius_factor);
            vertical_maxima = fitGridMaxima(grid_spacing_vertical, pixels_per_index, min_grid_threshold, true, grid_padding, true, suppression_radius_factor);
        ...
        */
                                 ...
                                 float supression_radius_factor)
        {
            ...
            if (best_fit_line != null)
            {
	            ...
	            horizontal_maxima = fitGridMaxima(grid_spacing_horizontal, pixels_per_index, min_grid_threshold, true, grid_padding, true, supression_radius_factor);
	            vertical_maxima = fitGridMaxima(grid_spacing_vertical, pixels_per_index, min_grid_threshold, true, grid_padding, true, supression_radius_factor);
