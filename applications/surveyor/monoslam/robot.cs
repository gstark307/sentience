...
namespace monoSLAM
{
    ...
    public class Robot : Sim_Or_Rob
    {
        ...
        public byte[] image_colour;
        public byte[] outputimage;
		public int outputimage_width, outputimage_height;
        ...
        /// </summary>
        /// <param name="image">mono camera image</param>
		/// <param name="image_width">width of the image</param>
		/// <param name="image_height">height of the image</param>
		/// <param name="image_colour">colour camera image</param>
		/// <param name="outputimage">mono image to be displayed</param>
		/// <param name="show_ellipses">whether to show ellipses</param>
        public virtual void load_new_image(byte[] image,
		                                   int image_width, int imager_height,
		                                   byte[] image_colour, 
		                                   byte[] outputimage, 
		                                   bool show_ellipses)       
		{
            ...
            this.image_colour = imageptr_colour;
        ...
        /// <param name="patchwidth">width of the patch</param>
        ...
        public void copy_into_patch(byte[] im,
		                            int image_width,
		                            byte[] patch,
		                            int patchwidth,
                                    uint uu, uint vv)
        {
            for (uint r = 0; r < Camera_Constants.BOXSIZE; r++)
                for (uint c = 0; c < Camera_Constants.BOXSIZE; c++)
                {
                    ...
                    patch[(r * patchwidth) + c] = image[(y * image_width) + x];
                }
        }
        ...
        public void measure_feature_with_multiple_priors(byte[] patch, ArrayList particle_vector)
        {
