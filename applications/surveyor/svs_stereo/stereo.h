...
#define SVS_VERTICAL_SAMPLING    6
#define SVS_DESCRIPTOR_PIXELS    24
...
extern int svs_match(int ideal_no_of_matches, int max_disparity_percent, int luminance_threshold, int descriptor_match_threshold);
