...
namespace SceneLibrary
{
    ...
    public class SearchMultipleOverlappingEllipses
    {
        ...
        public SearchMultipleOverlappingEllipses(byte[] image,
		                                         ...
		                                         uint BOXSIZE)
        {
            ...
            correlation_image = new float[m_image_width, m_image_height];
        }
        ...
        public virtual void search()
        {
            ...
            foreach (SearchDatum i in m_searchdata)
            {
                ...
                if (ucentre + urelfinish - (int)(m_boxsize - 1) / 2 >
                    (int)(m_image_width) - (int)(m_boxsize))
                {
                    urelfinish = (int)(m_image_width) - (int)(m_boxsize) -
                ...
                if (vcentre + vrelfinish - (int)(m_boxsize - 1) / 2 >
                    (int)(m_image_height) - (int)(m_boxsize))
                {
                    vrelfinish = (int)(m_image_height) - (int)(m_boxsize) -
        ...
        public byte[] image() { return m_image; }
        public byte[] patch() { return m_patch; }
        public uint boxsize() { return m_boxsize; }

        private byte[] m_image;
		private int m_image_width, m_image_height;
        private byte[] m_patch;
		//private int m_patch_width, m_patch_height;
