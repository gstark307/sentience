...
namespace surveyor.vision
{
    ...
    public class WebcamVisionDirectShowCapture : ISampleGrabberCB, IDisposable
    {
        ...
        public WebcamVisionDirectShowCapture(int iDeviceNum,
